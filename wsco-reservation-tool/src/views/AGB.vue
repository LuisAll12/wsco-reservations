...
import agbData from '../data/infoAGB.json'
...
<template>
    <div class="max-w-4xl mx-auto px-6 py-10 text-slate-800 bg-white rounded-lg shadow-md mt-6">
        <h1 class="text-3xl font-bold mb-8 text-center" v-if="agb">{{ agb.title }}</h1>

        <div v-if="agb" class="space-y-8">
            <div v-for="(section, index) in agb.sections" :key="index">
